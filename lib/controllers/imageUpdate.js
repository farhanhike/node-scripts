...
function runScript(legacyStickers) {
...
var legacyStickersList = require("./../../sticker_without_mini").legacySticker;

// runScript(legacyStickersList)

function getStickerWithoutMini() {
    LegacySticker.find({}, {catId:1, sId:1, img_avail:1}, function(error, legacyStickers) {
        if(error) {
            ...
            for(var i=0; i<legacyStickers.length; i++) {
                ...
                if(legacySticker.img_avail && legacySticker.img_avail.st == true && legacySticker.img_avail.stmn == true) {
                    var data = {
            ...
            jsonfile.writeFile("sticker_without_mini.js", result, {spaces: 2}, function (err) {
